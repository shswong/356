...
public class DatabaseEvent
{
    ...
    public DatabaseEvent(String eventName, String[] startTime, String[] endTime, String eventType, int classNumber, int priority)
    {
    ...
    public DatabaseEvent(int eventID, String eventName, String[] startTime, String[] endTime, int priority)
    {
        this.eventID = eventID;
        this.eventName = eventName;
        this.startTime = startTime;
    ...
    public DatabaseEvent(int eventID, String eventName, String[] startTime, String[] endTime, String eventType, int classNumber, int priority)
    {
        this.eventID = eventID;
        this.eventName = eventName;
        this.startTime = startTime;
    ...
    public String[] getTimeArr(String s)
    {
        ...
        startTimeArr[2] = s.substring(end+1, end+5);
        start = s.indexOf(':', end);
        startTimeArr[3] = s.substring(end+6, start);
        start += 1;
        end = s.indexOf(':', start);
        startTimeArr[4] = s.substring(start, end);
        start = end+1;
        end = s.indexOf(' ',end);
        startTimeArr[5] = s.substring(start, end);
